...
import com.vti.entity.Ex1.Answer;
import com.vti.entity.Ex1.CategoryQuestion;
import com.vti.entity.Ex1.CategoryQuestion.CategoryName;
import com.vti.entity.Ex1.Department;
import com.vti.entity.Ex1.Exam;
import com.vti.entity.Ex1.Group;
import com.vti.entity.Ex1.Position;
import com.vti.entity.Ex1.Position.PositionName;
import com.vti.entity.Ex1.Question;
import com.vti.entity.Ex1.TypeQuestion;
import com.vti.entity.Ex1.TypeQuestion.TypeQuesionName;
...
public class Exercise1 {
	...
	public void Question1() {
		...
		ex1.duration = 90;
		ex1.account = acc1;
		ex1.createDate = (java.sql.Date) new Date(2021 - 1900, 05 - 1, 12);
		...
		ex2.duration = 60;
		ex2.account = acc1;
		ex2.createDate = (java.sql.Date) new Date(2021 - 1900, 01 - 1, 31);
		...
		ex3.duration = 90;
		ex3.account = acc1;
		ex3.createDate = (java.sql.Date) new Date(2021 - 1900, 6 - 1, 11);
		...
		ex4.duration = 120;
		ex4.account = acc3;
		ex4.createDate = (java.sql.Date) new Date(2021 - 1900, 07 - 1, 21);
		...
		ex5.duration = 90;
		ex5.account = acc1;
		ex5.createDate = (java.sql.Date) new Date(2021 - 1900, 06 - 1, 21);
