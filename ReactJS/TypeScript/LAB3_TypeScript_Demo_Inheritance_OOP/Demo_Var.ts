...
var fullName: string = "Ngô Xuân Trường";
var age: number = 22;
var gender = "Male";
var address;
address = "HN";
...
var worker1 = new Worker(fullName, age, gender, address, rank);
...
function printWorker_array(): void {
  var workerArray: Worker[]; // Khai báo 1 mảng
  ...
  worker2 = new Worker(
    "Worker2_Name2_Change",
    22,
    "Male_Change",
    "HN_Change",
    9
  ); // khai báo lạiworker2 trong hàm này. thay đổi giá trị
  var worker4 = new Worker("Worker3", 22, "Male", "HN", 9); // Worker4 khai báo bên trong hàm, nênchỉ có phạm vi bên trong hàm này. ra ngoài sẽ không gọi được, giống khi báo với let
}
